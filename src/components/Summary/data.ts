export const resume = [
  ...
  },
  {
    ...
    institution: "Udemy",
    location: "Online",
    course: "Java - Programação Orientada a Objetos",
    description: `Temas abordados no curso com foco em prática:
  ...
  },
  {
    ...
    institution: "Udemy",
    location: "Online",
    course: "Desenvolvimento de jobs com Spring Batch",
  ...
  },
  {
    ...
    description: `Temas abordados no curso:
        Variáveis, Entrada e saída de dados, Comando de atribuição (processamento),
  ...
  },
  {
    ...
    institution: "Senac",
    location: "Niterói, RJ",
    course: "Curso livre Web Design",
    description: `Curso de capacitação incial focado em Web Design - HTML e CSS. 
